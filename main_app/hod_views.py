...
from .models import CustomUser, Parent, Student
...
def add_parent(request):
    ...
    if request.method == "POST":
        ...
        if not student_id:
            return HttpResponse("❌ Student not selected")
    ...
    return render(request, "hod_template/add_parent.html", {
        "students": students
    })

def manage_parent(request):
    parents = Parent.objects.all()
    return render(request, "hod_template/manage_parent.html", {"parents": parents})

def delete_parent(request, id):
    parent = Parent.objects.get(id=id)
    parent.admin.delete()  # supprime user aussi
    parent.delete()
...
def ia_dashboard(request):
    return render(request, 'hod_template/ia_dashboard.html')

def ia_alertes_decrochage(request):
    return render(request, 'hod_template/ia_alertes_decrochage.html')

def ia_prevision_absences(request):
    return render(request, 'hod_template/ia_prevision_absences.html')

def ia_recommandations(request):
    return render(request, 'hod_template/ia_recommandations.html')    