...
urlpatterns = [
    ...
    path("ia_dashboard", hod_views.ia_dashboard, name='ia_dashboard'),
path("ia_alertes_decrochage", hod_views.ia_alertes_decrochage, name='ia_alertes_decrochage'),
path("ia_prevision_absences", hod_views.ia_prevision_absences, name='ia_prevision_absences'),
path("ia_recommandations", hod_views.ia_recommandations, name='ia_recommandations'),
    ...
    path("staff_ia_dashboard", staff_views.staff_ia_dashboard, name='staff_ia_dashboard'),
    ...
    path("student_ia_dashboard", student_views.student_ia_dashboard, name='student_ia_dashboard'),
...
path("parent/edit/<int:id>/", views.edit_parent, name='edit_parent'),
path("parent/delete/<int:id>/", views.delete_parent, name='delete_parent'),
